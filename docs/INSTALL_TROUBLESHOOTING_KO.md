...
```text
addons/bluemap-web-chat/config.js?v=3.0.0-<cache-token>
addons/bluemap-web-chat/chat.js?v=3.0.0-<cache-token>
addons/bluemap-web-chat/chat.css?v=3.0.0-<cache-token>
```
