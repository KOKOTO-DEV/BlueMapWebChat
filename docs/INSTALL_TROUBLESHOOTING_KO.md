...
```text
addons/bluemap-web-chat/config.js?v=4.5.3-<cache-token>
addons/bluemap-web-chat/chat.js?v=4.5.3-<cache-token>
addons/bluemap-web-chat/chat.css?v=4.5.3-<cache-token>
```
